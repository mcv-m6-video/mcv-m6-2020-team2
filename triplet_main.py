...
from src.tracking_triplet.plots import show_batch
...
fit(model, n_epochs, train_loader, val_loader, scheduler, optimizer, loss_fn, log_interval, torch.cuda.is_available())
